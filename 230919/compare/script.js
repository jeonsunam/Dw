...
console.log(x == 1); // true, x 와 1 이 같다
console.log(x != 1); // false, x 와 1 다르다.
...
if(value > 10) {
    ...
    console.log(`${value}은 10과 같습니다.`)
}
else if (value < 10) {
    console.log(`${value}은 10보다 작습니다.`)
}
else {
console.error('잘 모르겠습니다.')
}
...
// 그렇지 않다면 "짬뽕을 먹을 수 있습니다"가 출력되도록 if문 작성
